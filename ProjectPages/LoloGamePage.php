...
contentContainer('<img src = "GamePageImages/lolobigBanner.png" class ="GamePageBanner" />');
...
<span class = "ProjectPageTitle">About The Adventures Lolo Recreated</span>
...
It is based around the old style games, I only used 16 by 16 tiles, and used only 4 colours on each tile (even transparency counts as a colour!) I also made sure to use the nes colour pallet :D
