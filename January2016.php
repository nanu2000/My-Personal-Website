...
Pretty much, for certain complex models (with big bone hierarchys) they would not animate exactly properly. As an example, the whole model would be folded in half or something alike.
...
<br>
Here is an example of the bug.<br>
<br>
</p>
...
and thats just one of the many perks I will recieve from creating my own engine, and overall creating my own game.
</p>
<p>
...
reason #3. I don\'t have to include assimp in my game at all, the engine tool will use assimp, but then export a binary file that doesn\'t
include any information that you need assimp for.
</p>
<br>
<p>
...
<h3>3D rendering and cleaning up some code!</h3>
");

echo('
<p>So for the past week I have erased my old rendering code from my 2D engine, and started working on my new rendering code for my 3D engine :D
...
<br>
<br><center><h5>A few textured cubes being rendered</h5></center>
<br>
...
<br>
<br><center><h5>The chest model in the <a class ="TextLink" href ="http://www.open3mod.com/">open 3D model viewer</a></h5></center>
<br>
...
startBlogPost
("
<h2>January 1st 2016</h2>
<h3>A Fresh New Beginning</h3>
");
...
</p><p>One of the more vital reasons I have is I also want everything I create now(for the engine) usable with any game that I might want to create with the engine. 
...
<p>The best thing about the method I chose is that when I actually start programming the game, I can use dependency injection if I want to. I am not limiting myself by using the service locator. All I would do is just use the audio class like normal (using dependency injection when needed) and never worry about the service locator and just remove it.</p>
<br><center>
<h4>On another note...</h4> </center><p>I am planning on adding more images and possibly videos(?) in the future, it\'s probably a little bit boring to just be reading text and I want to be as entertaining and informative as possible, so the best I can do is promise to add some more content other than text in the future. Please stay tuned :)</p>
');
